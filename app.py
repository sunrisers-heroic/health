...
LANGUAGES = {
    "en": {
        "footer": "Generated by Health Analytics Dashboard © All rights reserved",
        "subtitle": "Your Personal Health Assistant",
        "settings": "Settings"
    },
    "es": {
        "footer": "Generado por Health Analytics Dashboard © Todos los derechos reservados",
        "subtitle": "Tu Asistente de Salud Personal",
        "settings": "Configuración"
    },
    "fr": {
        "footer": "Généré par Health Analytics Dashboard © Tous droits réservés",
        "subtitle": "Votre Assistant de Santé Personnel",
        "settings": "Paramètres"
    }
}
